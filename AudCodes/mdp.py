...
def value_iteration(env, num_actions, num_states, theta=0.00001,
                    discount_factor=1.0):
	"""
...
def policy_evaluation(policy, env, num_actions, num_states,
                      discount_factor=1.0, theta=0.00001):
	"""
...
def policy_iteration(env, num_actions, num_states,
                     policy_eval_fn=policy_evaluation, discount_factor=1.0):
	"""
	...
	while True:
		...
		V = policy_eval_fn(policy, env, num_actions, num_states,
		                   discount_factor)
		policyStable = True
